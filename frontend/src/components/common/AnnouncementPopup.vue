  ...
  <Teleport to="body">
    <Transition name="popup-fade">
      <div
        ...
        class="fixed inset-0 z-[120] flex items-start justify-center overflow-y-auto p-4 pt-[8vh] backdrop-blur-md bg-black/30"
      >
        <div
          class="w-full max-w-[680px] overflow-hidden rounded-3xl bg-white shadow-glass ring-1 ring-black/5 dark:bg-dark-800 dark:ring-white/10"
          @click.stop
        >
          <!-- Header with warm gradient -->
          <div class="relative overflow-hidden border-b border-amber-100/80 px-8 py-6 dark:border-dark-700/50 bg-gray-50 dark:bg-dark-900">
            ...
            <div class="relative z-10">
              ...
              <div class="mb-3 flex items-center gap-2">
                ...
                <span class="inline-flex items-center gap-1.5 rounded-lg px-2.5 py-1 text-xs font-medium text-white shadow-glass bg-primary-600">
          ...
          <div class="border-t border-gray-100 bg-gray-50/50 px-8 py-5 dark:border-dark-700 dark:bg-dark-900/30">
            <div class="flex items-center justify-end">
              <button
                ...
                class="rounded-xl px-6 py-2.5 text-sm font-medium text-white shadow-glass transition-all bg-primary-600 hover:bg-primary-700"
              >
