<template>
  <header class="workspace-header sticky top-0 z-30">
    <div class="workspace-header-inner flex items-center justify-between gap-4">
      ...
      <div class="workspace-utilities flex shrink-0 items-center gap-1 sm:gap-2">
        <!-- Announcement Bell -->
        ...
        <SubscriptionProgressMini v-if="user" class="workspace-subscriptions" />

        <!-- Balance Display -->
        <div
          v-if="user"
          class="workspace-balance group relative hidden items-center gap-2 rounded-xl px-3 py-1.5 sm:flex"
        >
          <svg
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          <button
            ...
            aria-haspopup="true"
          >
            <div class="workspace-avatar flex h-8 w-8 items-center justify-center overflow-hidden rounded-full text-xs font-semibold">
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
                :alt="displayName"
            ...
            <div class="workspace-user-name hidden min-w-0 text-left xl:block">
              <div class="max-w-24 truncate text-sm font-medium text-gray-900 dark:text-white" :title="displayName">
                {{ displayName }}
              </div>
