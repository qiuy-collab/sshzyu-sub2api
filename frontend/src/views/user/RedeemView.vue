  ...
  <AppLayout>
    <div class="mx-auto max-w-2xl space-y-6">
      ...
      <div class="card overflow-hidden">
        <div class="border-b border-gray-100 bg-white px-6 py-8 text-center dark:border-dark-700 dark:bg-dark-800">
          <div
            class="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-gray-50 dark:bg-dark-900"
          >
            <Icon name="creditCard" size="xl" class="text-gray-500 dark:text-dark-400" />
          </div>
          <p class="text-sm font-medium text-gray-500 dark:text-dark-400">{{ t('redeem.currentBalance') }}</p>
          <p class="mt-3 text-5xl font-semibold tabular-nums tracking-tight text-gray-900 dark:text-white">
